...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../sopc_counter.sopcinfo
...
# Design Name 
# setting SOPC_NAME is sopc_counter
SOPC_NAME := sopc_counter
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1695028854
SOPC_SYSID_FLAG += --timestamp=1695028854
ELF_PATCH_FLAG  += --timestamp 1695028854
